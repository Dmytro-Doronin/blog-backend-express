...
exports.blogsRouter.get('/:id/posts', authMiddlewareWithBearer_1.customAuthMiddlewareWithBearer, compositionRoot_1.blogControllerInstance.getAllPostInBlogController.bind(compositionRoot_1.blogControllerInstance));
