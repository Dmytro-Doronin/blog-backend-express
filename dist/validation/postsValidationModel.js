...
exports.likeStatus = (0, express_validator_1.body)('likeStatus')
    .isString()
    .trim()
...
const likeStatusModelMiddleware = () => [exports.likeStatus];
exports.likeStatusModelMiddleware = likeStatusModelMiddleware;
